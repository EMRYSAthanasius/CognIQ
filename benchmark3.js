...
const opt_array = runBenchmark('opt_array');

console.log(`Baseline: ${baseline.toFixed(2)} ms`);
console.log(`Optimized (array): ${opt_array.toFixed(2)} ms`);
console.log(`Improvement (array): ${(((baseline - opt_array) / baseline) * 100).toFixed(2)}%`);
